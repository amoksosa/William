...
<head>
  ...
  <style>
    ...
    * { outline-color:#60a5fa; }
    ...
    /* Layout */
    .main-grid{ display:grid; grid-template-columns:1fr 820px; gap:1.8rem; align-items:start; }
    ...
    /* Game board with animated border glow */
    ...
    /* inside gameboard: main content + right sidebar */
    ...
    <div class="original-jackpot-content">
      ...
      <section class="text-center preserve">
        <img id="wilyLogo"
          ...
          alt="WILYONARYO"
          class="mx-auto mb-2 md:mb-3 w-[clamp(22rem,60vw,48rem)] h-auto drop-shadow-[0_6px_18px_rgba(0,0,0,.45)]"/>
        <h1 id="jackpot" class="jackpot-font text-[clamp(2rem,6vw,5rem)] leading-none font-extrabold tracking-[.08em] text-glow">JACKPOT</h1>
        <h2 id="prize"   class="jackpot-font text-[clamp(1.6rem,5vw,3.8rem)] -mt-1 font-extrabold tracking-[.32em] text-glow">PRIZE</h2>
